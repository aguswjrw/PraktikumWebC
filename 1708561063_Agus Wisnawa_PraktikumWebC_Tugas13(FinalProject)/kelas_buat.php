            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <form form action="function.php?act=buatKelas" id="buat" method="POST" >
                                <div class="form-group ml-4 py-3 mb-0">
                                    <label for="namaKelas">Nama Kelas</label>
                                    <input type="text" class="form-control col-sm-3" id="namaKelas" name="namaKelas"  placeholder="Masukkan Nama Kelas">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="jamKuliah">Jam Kuliah</label>
                                    <input type="text" class="form-control col-sm-3" id="jamKuliah" name="jamKuliah"  placeholder="Masukkan Jam Kuliah">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="kuotaKelas">Kuota Kelas</label>
                                    <input type="number" class="form-control col-sm-3" id="kuotaKelas" name="kuotaKelas"  placeholder="Masukkan Kuota Kelas">
                                </div>
                                <div class="form-group ml-4 ">
                                ...
                                <input type="submit" name="buat_btn" id="buat" class="btn btn-primary ml-4 mb-3" value="Buat Kelas">
                            </form>
                        </div>
                    </div>
                </main>
