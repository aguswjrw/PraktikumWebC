...
$queryDosen = mysqli_query($koneksi, "SELECT * FROM dosen WHERE id_dosen='$id'");
$data = mysqli_fetch_assoc($queryDosen);
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">Update Status Dosen</h3>
                        <div class="card mb-4">
                            <form form action="function.php?act=edit_dosen&id_dosen=<?= $id; ?>" id="buat" method="POST" >
                                ...
                                <input type="submit" name="buat_btn" id="buat" class="btn btn-primary ml-4 mb-3" value="Update Status Dosen">
                            </form>
                        </div>
                    </div>
                </main>
