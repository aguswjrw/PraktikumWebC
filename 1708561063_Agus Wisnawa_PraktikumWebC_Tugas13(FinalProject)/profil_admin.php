<?php 
    ...
    $queryUser = mysqli_query($koneksi, "SELECT * FROM adminsimak WHERE id_admin = '$id'");
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="function.php?act=editAdmin&id_admin=<?= $user['id_admin']; ?>" id="edit" method="POST" >
