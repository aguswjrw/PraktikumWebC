                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="kelas.php">Daftar Kelas</a>
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Aksi</th>
                                                    <?php } ?>
                                                    <th class="col-sm-auto">Nama Kelas</th>
                                                    <th class="col-sm-auto">Nama Dosen</th>
                                                    <th class="col-sm-auto">Jam Kuliah</th>
                                                    <th class="col-sm-auto">Kuota Kelas</th>
                                                    <th>Status</th>
                                                </tr>
                                            </thead>
                                            <?php $i=1; ?>
