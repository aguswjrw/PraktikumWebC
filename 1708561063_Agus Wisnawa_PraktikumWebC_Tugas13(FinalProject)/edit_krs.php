...
$queryKRS = mysqli_query($koneksi, "SELECT * FROM krs INNER JOIN matakuliah ON krs.id_mk=matakuliah.id_mk WHERE id_krs = '$id'");
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="function.php?act=editKRS&id_krs=<?= $id; ?>" id="tambah" method="POST" >
                                <div class="form-group ml-4 py-3 mb-0">
                                    <label for="semester" class="form-label">Semester</label>
                                    <select name="semester" id="semester" class="form-control col-sm-3">
                                        <option value="<?= $krs['semester']; ?>"><?= $krs['semester']; ?></option>
                                ...
                                <div class="form-group ml-4 ">
                                    ...
                                    <select name="matakuliah" id="matakuliah" class="form-control col-sm-3">
                                        <option value="<?= $krs['id_mk']; ?>"><?= $krs['matakuliah']; ?></option>
