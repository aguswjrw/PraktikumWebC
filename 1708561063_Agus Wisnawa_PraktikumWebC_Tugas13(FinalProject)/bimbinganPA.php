            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">Menambah Bimbingan PA</h3>
                        <div class="card mb-4">
                            <form form action="function.php?act=bimbinganPA" id="buat" method="POST" >
                                ...
                                <input type="submit" name="buat_btn" id="buat" class="btn btn-primary ml-4 mb-3" value="Tambah Bimbingan PA">
                            </form>
                        </div>
                    </div>
                </main>
