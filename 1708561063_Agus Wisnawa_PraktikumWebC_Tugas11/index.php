...
$koneksi = mysqli_connect("localhost","root","","modul10") or die(mysqli_error());
	...
	<table>
	  ...
	  <tr>
	  	<th><b><a>Jenis Kelamin</a></b></th>
	  	<th><select id="kelamin" class="select">
	  ...
	  <tr>
	  	<th><b><a>Agama</a></b></th>
	  	<th><select id="agama" class="select">
        <option value="all"></option>
